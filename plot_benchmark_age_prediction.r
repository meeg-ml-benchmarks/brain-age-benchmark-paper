...
my_ggsave('./figures/fig_performance_r2', plot = fig_r2, dpi = 300, width = 8, height = 6)
...
my_ggsave('./figures/fig_performance_mae', plot = fig_mae, dpi = 300,  width = 8, height = 6)
...
tab <- kbl(agg_cv, caption = "Table 1. Aggregate cross-validation results across benchmarks and datasets", digits = 2)
